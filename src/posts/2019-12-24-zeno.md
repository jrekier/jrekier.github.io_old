...
$$
\begin{aligned}
&\left(\frac{1}{2^n}\right)_{n\in\mathbb{N}_0}~.&(1)
\end{aligned}
$$
...
$$
\begin{aligned}
&\sum_{n=0}^{\infty}\alpha^n=\frac{1}{(1-\alpha)}~.&(2)
\end{aligned}
$$


We will use this result again at the end of this note. From the above we can see that the series of terms in the sequence Eq. $(1)$ converges to
...
$$
\begin{aligned}
1^\text{st} \text{term}:&&&\frac{1}{3},\\[1em]
2^\text{nd} \text{term}:&&&\frac{1}{3}(1-\frac{1}{3})=\frac{2}{9},\\[1em]
3^\text{rd} \text{term}:&&&\frac{1}{3}(1-\frac{1}{3}-\frac{2}{9})=\frac{4}{27},\\[1em]
4^\text{th} \text{term}:&&&\frac{1}{3}(1-\frac{1}{3}-\frac{2}{9}-\frac{4}{27})=\frac{16}{81}~.\\[1em]
&&&\vdots
\end{aligned}
$$
...
$$
\begin{aligned}
1^\text{st} \text{term}:&&&\frac{1}{4},\\[1em]
2^\text{nd} \text{term}:&&&\frac{1}{4}(1-\frac{1}{4})=\frac{3}{16},\\[1em]
3^\text{rd} \text{term}:&&&\frac{1}{4}(1-\frac{1}{4}-\frac{3}{16})=\frac{9}{64},\\[1em]
4^\text{th} \text{term}:&&&\frac{1}{4}(1-\frac{1}{4}-\frac{3}{16}-\frac{9}{64})=\frac{27}{256}.\\[1em]
&&&\vdots
\end{aligned}
$$
